...
TEST(mtrk, mtrk_full_check)
{
    ...
    constexpr std::array<uint8_t, 79> data = {0x4D, 0x54, 0x72, 0x6B, 0x00, 0x00, 0x00, 0x47, 0x00, 0xFF, 0x51, 0x03,
                                              0x07, 0x90, 0xFC, 0x00, 0xFF, 0x58, 0x04, 0x04, 0x02, 0x18, 0x08, 0x00,
                                              0xFF, 0x03, 0x07, 0x33, 0x78, 0x4F, 0x73, 0x63, 0x20, 0x31, 0x00, 0x90,
                                              0x3C, 0x64, 0x60, 0x80, 0x3C, 0x40, 0x00, 0x90, 0x38, 0x64, 0x30, 0x80,
                                              0x38, 0x40, 0x00, 0x90, 0x3C, 0x64, 0x30, 0x80, 0x3C, 0x40, 0x00, 0x90,
                                              0x37, 0x64, 0x81, 0x70, 0x80, 0x37, 0x40, 0x00, 0x90, 0x38, 0x64, 0x30,
                                              0x80, 0x38, 0x40, 0x40, 0xFF, 0x2F, 0x00};

    EXPECT_EQ(mtrk_unmarshal(mtrk_ctx.get(), data.data(), data.size()), data.size());

    EXPECT_TRUE(0 == std::memcmp(mtrk_ctx->mtrk, k_mtrk_header_reference, MTRK_MARKER_SIZE));
